...
public class SeatDao {
    ...
    public SeatDo getSeatById(final int id) { return seatMapper.getSeatById(id); }

    public boolean addSeat(final SeatDo seat) {
        return seatMapper.addSeat(seat) > 0;
    }

    public boolean updateSeat(final SeatDo seat) { return seatMapper.updateSeat(seat) > 0; }
